...
import com.sourabhkulkarni.musicPlayer.MusicAdapter.MyHolder
import com.sourabhkulkarni.musicPlayer.databinding.MusicViewBinding
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        when{
            ...
            selectionActivity ->{
                ...
                holder.root.setOnClickListener {
                when{
                    MainActivity.search -> sendIntent(ref = "MusicAdapterSearch", pos = position) //Search Code
