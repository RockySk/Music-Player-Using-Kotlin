...
import com.sourabhkulkarni.musicPlayer.databinding.ActivityFeedbackBinding
import java.util.*
import javax.mail.*
...
class FeedbackActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.sendFA.setOnClickListener {
            ...
            val userName = "sourabhk2887@gmail.com"
            val pass = "sourabhk"
            ...
            if(feedbackMsg.isNotEmpty() && subject.isNotEmpty() && (cm.activeNetworkInfo?.isConnectedOrConnecting == true)){
                ...
                Toast.makeText(this, "Thanks For Feedback!, I Will Look Into It.!", Toast.LENGTH_SHORT).show()
                finish()
            }
