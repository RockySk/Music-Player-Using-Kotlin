...
import com.sourabhkulkarni.musicPlayer.databinding.ActivityMainBinding
import java.io.File
import java.util.*
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(themeIndex == 4 &&  resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK == Configuration.UI_MODE_NIGHT_NO)
            Toast.makeText(this, "Black Theme Works Best in Dark Mode!!, Try it..", Toast.LENGTH_LONG).show()
        ...
        binding.shuffleBtn.setOnClickListener {
            ...
            Toast.makeText(this, "Shuffled Song Playing Now As requested By The User", Toast.LENGTH_SHORT).show()
        }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        if(requestCode == 13){
            if(grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                Toast.makeText(this, "Permission Granted To The User.",Toast.LENGTH_SHORT).show()
                initializeLayout()
            }
            else
                ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.WRITE_EXTERNAL_STORAGE), 13)
    ...
    @RequiresApi(Build.VERSION_CODES.R)
    // for accessing songs from the Disk
